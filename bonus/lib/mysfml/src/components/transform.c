...
sf_transform_t *create_transform(gameobject_t *parent)
{
	...
	new_transform->position = (sf_vector_3d_t){0.0, 0.0, 0.0};
	new_transform->rotation = (sf_vector_3d_t){0.0, 0.0, 0.0};
	new_transform->scale = (sf_vector_3d_t){1.0, 1.0, 1.0};
...
int default_rotate_transform(sf_transform_t *transform, sf_vector_3d_t rotation)
{
	if (transform == NULL) {

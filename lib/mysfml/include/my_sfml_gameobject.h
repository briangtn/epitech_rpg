...
struct my_sfml_transform {
	...
	sf_vector_3d_t position; /**< Position of the gameobject in the world */
	sf_vector_3d_t rotation; /**< Rotation of the gamobject */
	sf_vector_3d_t scale; /**< Scale if the gameobject */
...
*/
int default_move_transform(sf_transform_t *transform, sf_vector_3d_t movement);
/**
** \brief Default rotate function
** @param transform the transform to rotate
** @param rot the rotation to apply on the transform
**
** This function will add the rotation to the transform.
** Return 84 in case of an error, 0 otherwise.
*/
int default_rotate_transform(sf_transform_t *transform, sf_vector_3d_t rot);
/**
...
** Return 84 in case of an error, 0 otherwise.
*/
int default_resize_transform(sf_transform_t *transform, sf_vector_3d_t scale);
...
struct my_sfml_collider_2d {
	...
	int collides; /**< Should the object collide in the physic engine */
...
** Return 1 if there is collision, 0 otherwise.
*/
int does_point_collide(gameobject_t *go, sf_vector_3d_t point);
/**
...
performed on the gameobject but collisions and trigger will still work */
	sf_vector_3d_t charge; /**< Vector that can be used as temporary \
variable for acceleration or speed (jumping for exemple) */
	sf_vector_3d_t acceleration; /**<Acceleration vector of the gameobject*/
	sf_vector_3d_t speed; /**< Speed vector of the gameobject */

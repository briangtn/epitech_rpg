...
static void render_particles(sf_graph_engine_t *graph_engine, \
sfRenderWindow *window)
{
	if (graph_engine->particle_manager != NULL)
		graph_engine->particle_manager->render(window, \
graph_engine->particle_manager);
}
